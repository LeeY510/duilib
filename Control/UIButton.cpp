...
namespace DuiLib
{
    ...
    void CButtonUI::SetBGRNormalImage(LPCTSTR pStrImage, unsigned char* bytesImg, DWORD bytesLength, int iWidth, int iHeight, bool bShare)
    {
    ...
    void CButtonUI::SetBGRHotImage(LPCTSTR pStrImage, unsigned char* bytesImg, DWORD bytesLength, int iWidth, int iHeight, bool bShare)
    {
        if (!SetBGRImage(pStrImage, bytesImg, bytesLength, iWidth, iHeight, bShare))
        {
            return;
