...
CComboUI::CComboUI() : m_pWindow(NULL), m_iCurSel(-1), m_uButtonState(0), m_bScrollSelect(false)
{
...
bool CComboUI::SelectItemByText(LPCTSTR pstrText, bool bTakeFocus /*= false*/)
{
    int n = GetCount();
    for (int i = 0; i < n; ++i)
    {
        ...
        {
            return SelectItem(i, bTakeFocus);
        }
    }
    return false;
}
