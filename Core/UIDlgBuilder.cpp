...
CControlUI* CDialogBuilder::_Parse(CMarkupNode* pRoot, CControlUI* pParent, CPaintManagerUI* pManager)
{
    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            switch( cchLen ) {
			case 3:
				if (_tcscmp(pstrClass, DUI_CTR_WND) == 0)                     pControl = new CWndUI;
                else if (_tcscmp(pstrClass, DUI_CTR_GIF) == 0)                pControl = new CGifUI;
				break;
            case 4:
                ...
                else if (_tcscmp(pstrClass, DUI_CTR_TABS) == 0)               pControl = new CTabsUI;
                break;
            case 5:
            ...
            case 7:
                ...
                else if (_tcscmp(pstrClass, DUI_CTR_TABPANE) == 0)            pControl = new CTabPaneUI;                
                break;
            case 8:
			...
			case 11:
				...
				break;
            case 13:
                if (_tcscmp(pstrClass, DUI_CTR_ELLIPSEBUTTON) == 0)			  pControl = new CEllipseButtonUI;
                break;
            case 14:
