...
public:
    ...
    const static TImageInfo* GetShareImage(LPCTSTR bitmap);
    const TImageInfo* GetImageEx(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
    const TImageInfo* GetGdiplusImage(LPCTSTR bitmap);
    const static TImageInfo* GetShareGdiplusImage(LPCTSTR bitmap);
    const TImageInfo* GetGdiplusImageEx(LPCTSTR bitmap);
    const TImageInfo* AddImage(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
    const TImageInfo* AddImage(LPCTSTR bitmap, HBITMAP hBitmap, int iWidth, int iHeight, bool bAlpha, bool bShare);
    const TImageInfo* AddGdiplusImage(LPCTSTR bitmap, LPCTSTR type = NULL, bool bShare = false);
    bool RemoveImage(LPCTSTR bitmap);
    bool static RemoveShareImage(LPCTSTR bitmap);
    bool RemoveGdiplusImage(LPCTSTR bitmap);
    bool static RemoveShareGdiplusImage(LPCTSTR bitmap);
    void RemoveAllImages();
    void ReloadAllImages();
    void static RemoveAllShareImages();
    ...
    CControlUI* FindControl(LPCTSTR pstrName, bool is_assert = true) const;
...
private:
    ...
    static CStdStringPtrMap m_mShareImageHash;
    CStdStringPtrMap m_mGdiplusImageHash;
    static CStdStringPtrMap m_mGdiplusShareImageHash;
