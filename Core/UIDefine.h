...
#define DUI_MSGTYPE_MENUITEMCLICK          (_T("menuitemclick"))
...
#define  DUI_CTR_TABPANE                         (_T("TabPane"))
...
#define  DUI_CTR_ELLIPSEBUTTON                   (_T("EllipseButton"))
