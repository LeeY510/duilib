...
public:
    ...
    void SetBkImage(LPCTSTR pStrImage, unsigned char* bytesImg, DWORD bytesLength, bool bShare);
    void SetBGRBkImage(LPCTSTR pStrImage, unsigned char* bytesImg, DWORD bytesLength, int iWidth, int iHeight, bool bShare);
    bool SetBGRImage(LPCTSTR pStrImage, unsigned char* bytesImg, DWORD bytesLength, int iWidth, int iHeight, bool bShare);
    ...
    void NeedUpdate(bool bRefresh=true);
